...
public class Gost28147 {    
    ...
    //массив ключей
    private final String[] k = {"733D2C20", "65686573", "74746769", "79676120", "626E7373", "20657369", "326C6568", "33206D54"};
    
    //синхропосылка
    private final String synchMsg = "5C713FA2D7B58429";
     ...
     */
    public byte[] gammaEncrypt(byte[] data){
     ...
     */
    public byte[] gammaDecrypt(byte[] data){
        int count = (int) Math.ceil(data.length / 8) + 1;
        byte[] forE32;
        forE32 = toByteArray(synchMsg);
        byte[] res = new byte[data.length];
     ...
     */
    private byte[] basicStep(byte[] data, int keyNumber) {
     ...
     */
    private byte[] replacement(byte[] data) {
        byte[] res = new byte[4];
